...
<main id="a-top">
  ...
  <section class="band grain hero hero--frog">
    ...
    <div class="inner">
      ...
      <p class="hero-onepc rise">The last one per cent</p>
      <div class="hero-rule rise" aria-hidden="true"><i></i><b></b><i></i></div>
      <p class="creed rise">
        <span>A living world that belongs to all of us.</span>
        <span>A place to come together.</span>
      </p>
      <p class="behere rise">Be here</p>
      <form class="join rise">
        <label class="sr">Your name<span hidden></span></label>
        <input name="name" type="text" required placeholder="Your name" autocomplete="name">
        <button class="btn btn--solid" type="submit">I am here</button>
        <p role="status" class="join-msg"></p>
      </form>
      <p class="join-alt rise">or <a href="#donate">give now</a> to help acquire and protect Wallum</p>
      <p class="hero-what rise">Below: CLAI's existing website copy, unedited &mdash; {total:,} words
        across {len(SECTIONS)} sections.</p>
    </div>
  </section>
